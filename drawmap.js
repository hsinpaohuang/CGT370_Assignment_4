var tip = d3.tip().attr('class', 'd3-tip').html(function(d) { return '<strong>Name: </strong> <span class="details">' + d.properties.NAME + '<br /></span> <strong>Labor Work Ratio: </strong> <span class="details">' + d.data.ratio + '</span>'; });
